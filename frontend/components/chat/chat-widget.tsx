...
const suggestedPrompts: SuggestedPrompt[] = [
  {
    id: "intel-vs-amd",
    label: "Intel vs AMD - Which CPU brand?",
    prompt: "What are the key differences between Intel and AMD CPUs for gaming? Which brand offers better value in 2024? When should I choose one over the other?",
  },
  {
    id: "gpu-tiers",
    label: "GPU tiers explained (budget to high-end)",
    prompt: "Explain the different GPU performance tiers from budget to high-end. What resolution and frame rates can I expect from each tier? How do NVIDIA and AMD compare?",
  },
  {
    id: "budget-allocation",
    label: "How to allocate PC build budget",
    prompt: "How should I allocate my budget across different components for a gaming PC? What percentage should go to GPU vs CPU? Where can I save money without hurting performance?",
  },
  {
    id: "psu-guide",
    label: "PSU wattage and efficiency guide",
    prompt: "How do I calculate the right PSU wattage for my build? What's the difference between 80+ Bronze, Gold, and Platinum efficiency ratings? What brands are most reliable?",
  },
  {
    id: "cooling-guide",
    label: "Air vs liquid cooling explained",
    prompt: "When do I need liquid cooling vs air cooling for my CPU? What are the pros and cons of each? How do I know if my case has good airflow?",
  },
  {
    id: "compatibility",
    label: "Component compatibility checklist",
    prompt: "What compatibility factors should I check when building a PC? How do I ensure my CPU, motherboard, RAM, case, and cooler all work together?",
  },
  {
    id: "ddr4-vs-ddr5",
    label: "DDR4 vs DDR5 RAM comparison",
    prompt: "Should I get DDR4 or DDR5 RAM? What's the real-world performance difference for gaming? Is DDR5 worth the extra cost in 2024?",
  },
  {
    id: "bottleneck",
    label: "How to avoid bottlenecks",
    prompt: "What is a CPU/GPU bottleneck and how do I avoid it? How do I balance my CPU and GPU choices for optimal gaming performance?",
  },
  {
    id: "ssd-storage",
    label: "SSD types and storage advice",
    prompt: "What's the difference between SATA SSDs, NVMe Gen 3, and Gen 4? How much storage do I need for gaming? Should I get one big SSD or multiple drives?",
  },
  {
    id: "first-build",
    label: "First-time builder tips",
    prompt: "I'm building my first PC. What are the most common mistakes beginners make? Any tips for the build process and cable management?",
  },
]
